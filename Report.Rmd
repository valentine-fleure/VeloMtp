...
# Distance et Durée 
La distance moyenne parcourue par les utilisateurs de vélo à Montpellier est `r mean(Course_velo$Covered.distance)` km. 
La durée moyenne d'un trajet avec un velo Velomagg à Montpellier est de `r mean(Course_velo$Duration)` minutes
